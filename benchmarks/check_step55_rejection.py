"""第 55 关：拒绝采样验证层（第五十四关的用例 + 本关的一般 p/q 用例）。
...
from step55.sampling import SamplingParams, SamplingState, TorchSampler
from step55.speculative import DraftVerification, residual_probs, verify_drafts_random
