...
from step52 import Engine, KVCachePool, SequenceConfig
from step52.speculative import propose_ngram, verify_drafts
...
check("最小合法组合能构造出来", ok_engine.speculative_mode == "ngram")
...
from step52.scheduler import Scheduler
