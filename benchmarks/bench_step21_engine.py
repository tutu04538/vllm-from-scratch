"""step20/21 paired comparison: unequal prefill, mixed arrival, warm mixed arrival.
...
def main():
    ...
    path=PROJECT/'benchmarks/results'/('step21_compare_'+args.workload+'_'+args.mode+'_'+datetime.now(timezone.utc).strftime('%Y%m%dT%H%M%S.%fZ')+'_'+str(os.getpid())+'.json')
