"""第 37 关：query 分块的分页 prefill attention。
...
__all__ = [
    ...
    "AttentionMetadata", "paged_attention", "tiled_paged_attention", "KVCachePool", "CacheConfig", "SequenceConfig",
    "Sampler", "Scheduler", "save_model", "load_model_config", "load_model_weights",
    "build_model_from_config", "native_format", "qwen3_format",
    "DEFAULT_EOS_TOKEN_IDS", "GENERATION_CONFIG_NAME", "rms_norm",
